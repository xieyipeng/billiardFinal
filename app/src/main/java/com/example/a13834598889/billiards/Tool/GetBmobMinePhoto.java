...
import static com.example.a13834598889.billiards.FragmentCustomerMine.Fragment_mine.setInterfacePhotoMine;
...
//                                Log.e(TAG, "onStart: " + temp + "开始下载文件：");
                            ...
                            public void done(String savePath, BmobException e) {
                                if (e == null) {
                                    ...
                                    switch (requesCode) {
                                        case 1:
                                            setInterfacePhotoMine(bitmap);
                                            Log.e(TAG, "done: fragment_mine 界面头像下载成功");
                                            break;
                                        case 2:
                                            setShopShowIconMine(bitmap);
                                            Log.e(TAG, "done: fragment_mine 界面头像修改成功");
                                            break;
                                        default:
                                            break;
                                    }
...
//                                Log.e(TAG, "onFinish: " + temp + "文件下载完成");
                        ...
                        Fragment_mine.profilePhoto.setImageBitmap(bitmap);
                    }
                } else {
